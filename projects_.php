...
<h3>Tourism Itinerary (USMB-UPPA / 2018-2019)</h3>
<p>
...
<h3>Transfrontour (Interreg / 2016-2019)</h3>
<p>
...
<h3>Action PING (GDR GPL / 2013-2014)</h3>
<p>
This specific PING workgroup deals with software engineering curricula and practices; it aims at drawing a common curricula framework and possibly a dedicated plateform and specific set of tools/toolkits. 
  ...
  <h3>OpenCloudware (2012-2014)</h3>
<p>
The OpenCloudware project aims at building an open software engineering platform, for the collaborative development of distributed applications to be deployed on multiple Cloud infrastructures.
...
OpenCloudware is a collaborative project. The project members include industry and academic leaders, innovative technology start-ups and a world-renowned open source community.

OpenCloudware outputs will be offered under an OSI compliant open source license and the code distributed via the OW2 Consortium software forge as part of the OW2 Open Source Cloudware Initiative.


</p>

  <h3>Performance SOA (2011-2012)</h3>
<p>
  This project adresses SOA performance and quality. Methodological approaches (performance indicators, SOA metrics, QoS, information fusion methods,...) are investigated and part of the work will be fondaments for a services orchestration supervision system. 
  This project also deals with applying a Service-based approach to (1) manufacturing enterprise architectures and to (2) image processing software systems.
</p>
  <h3>ISPRIT PLM (2009-2011)</h3>
<p>
...
<h3>Web Intelligence (2004-2008 and 2008-2011)
</h3>
<p>
R&eacute;gion Rh&ocirc;ne-Alpes three years funded project, cluster <i>Informatique, Signal, Logiciel Embarqu&eacute; (Computer Science, Signal, Embedded systems)</i>.
</p>
<p>
...
<p>
Cook is a ANR 2006 three years project funded by <a target="_blank" href="http://www.gip-anr.fr/">GIP-ANR</a> (JC05 42872).
</p>
<p>
The project is focusing on architecture refactoring. A one week and enthousiastic Moose environment tutorial has been organized and animated by <a href="http://www.iam.unibe.ch/%7Egirba/" target="_blank">Tudor Girba</a>.
This project partially supports <a href="./software.php">Nimrod</a> environment. 
</p>
...
<p>
ArchWare designed, developed, and disseminated innovative
architecture-centric languages, frameworks and tools for engineering
evolvable software systems. It defined formal architectural
style-based languages for describing and analysing design-time and
run-time evolvable software architectures taking into account reuse of
components. Customised process-driven environments provided tools
to support architectural models (including quality attributes),
reasoning about these models, and refining them into compliant
implementations. The project built on and advanced baseline
complementary researches in the areas of software architectures and
reflective frameworks from three EU member states. The adequacy and
industrial relevance of the project results were validated in
real-life business cases from different industrial domains.
</p>
...
<p>
Langages et outils pour les architectures orient&eacute;es services Web : l'ubiquit&eacute; dans l'Internet de 3&egrave;me g&eacute;n&eacute;ration au service de l'int&eacute;gration des applications d'entreprises en r&eacute;seau.
</p>
<p>
R&eacute;gion Rh&ocirc;ne-Alpes Emergence program French funded project. WebWare aimed at providing a Services Oriented Architectures
development framework. This project focused on SOA descriptions according to a
formal-based approach. The experimentation addressed a <i>Manufacturing
Execution System</i> scenario involving several interacting Web
Services.
</p>
...
<p>
R&amp;D project in partnership with IUP GSI and Club ERA (associating some editors of ERP and software solutions for industrial
customers). This project addressed a technical solution for integrating
existing industrial software solutions, ERP, legacy systems,..., by the
way of Web Services.
</p>
...
<p>
PIE (Process Instance Evolution), European Esprit-IV Open LTR project n&deg; 34840
</p>
<p>
The objective of PIE was to define a framework allowing managers to pilot and implement on-line
dynamic evolution and changes to distributed work activity supported by
distributed instances of process models. The PIE consortium developed a
methodology for process dynamic evolution based on the following
approaches:
</p>
      <ul>
        <li>
...
<h3>Contracts - Industrial partnerships</h3>
<lu>
<li>I am the scientific responsible and coordinator for the Opendil project that is a R&amp;D transfert and valorisation project based on the ArchWare project results.</li>
<li>I lead a partnership with M1i, a small industrial software editor (within the Samuel Meril's PhD context).</li>
<li>I was the WebWare's scientific responsible.</li>
<li>State of the art: interoperability between software applications - 1998 - Partners: LLP Lab. and EDF-Research Division</li>
</lu>
